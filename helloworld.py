...
def canc1():
  text1= tkinter.Entry.clipboard_clear()
  text2=" "
  text3=" "
  text4=" "
  text5=" "
...
roots = tkinter.Tk()
roots.title("Student registration Form")
roots.geometry("1000x1000")
lb1 = tkinter.Label(roots, text="Fill your entries").grid(row=0, column=0, sticky=tkinter.W)
lb2 = tkinter.Label(roots, text="Full Name").grid(row=1, column=0, sticky=tkinter.W)
lb3 = tkinter.Label(roots, text="Mobile Number").grid(row=2, column=0, sticky=tkinter.W)
lb4 = tkinter.Label(roots, text="City").grid(row=3, column=0, sticky=tkinter.W)
lb5 = tkinter.Label(roots, text="Password for Login").grid(row=4, column=0, sticky=tkinter.W)
lb6 = tkinter.Label(roots, text="Email ID/ Login ID").grid(row=5, column=0, sticky=tkinter.W)
lb7 = tkinter.Label(roots, text="Course").grid(row=1, column=7, sticky=tkinter.W)
lb8 = tkinter.Label(roots, text= "Board").grid(row=2, column=7, sticky=tkinter.W)
text1 = tkinter.Entry(roots).grid(row=1, column=3, sticky=tkinter.W)
text2 = tkinter.Entry(roots).grid(row=2, column=3, sticky=tkinter.W)
text3 = tkinter.Entry(roots).grid(row=3, column=3, sticky=tkinter.W)
text4 = tkinter.Entry(roots).grid(row=4, column=3, sticky=tkinter.W)
text5 = tkinter.Entry(roots).grid(row=5, column=3, sticky=tkinter.W)
text6 = tkinter.Entry(roots).grid(row=1, column=10, sticky=tkinter.W)
text7 = tkinter.Entry(roots).grid(row=2, column=10, sticky=tkinter.W)
button1 = tkinter.Button(roots, text="Submmit", width=6, command=sub1).grid(row=10, column=2, sticky=tkinter.W)
button2 = tkinter.Button(roots, text="Cancel", width=6, command=canc1).grid(row=10, column=6, sticky=tkinter.W)
